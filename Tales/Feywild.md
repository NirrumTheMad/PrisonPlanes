...
**Dm's Note:** Many of the fey are built Anthropomorphically, and generally arranged in human shape and with human concerns. This does not need to be the case in your game, as the realm of the fey is a reflection of one's self in many ways, and so too is it not uncommon for one fey to be swapped out with a *nearly* identical copy. Do what is right for the story and the experience.
...
IF you want a completely sane fey projection, like a nerd, any given region of the fey follows these rules or just use a C120 Projection of a hyperdodecahedron, because if you're here for this part, you're probably crazy and I want to hear all of it:
	There is an up and a downside to any 3-space orientation, they are different places occupying the same regional space, and are differentiated by some (magical) difference in 4-space orientation, specifically a full inversion along one axis. For a fun version of this effect, Standing on one's head and spinning counterclockwise is enough to get you to the other side, though the geographical features may be prohibitive through movement from one side of the face to another. 
	
	Moving any amount in any direction can bring you to one of two other possible locations, in the same orientation. Moving in a "straight line" realative to your local projection of 3 space will bring your back to your original location after 1.028 planar lengths. For ease, this will be about six full days' travel on foot. You'll move out of a region in 0.324 planar lengths, or about two full days walk in a straight line. Any deviation at all can lead you to one of two other sets of 12 regions, each of which share one region with the region set you just moved out of. In a nearly infinitely improbable chance, one may travel across a vertex and end up in one of //six// adjacent regions.  
