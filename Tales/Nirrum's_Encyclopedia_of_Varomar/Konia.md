...
**As of late 5854, Konia has been reduced to a massive circular lake  after a cult attack. **
...
### Environment 
	Temperate climate
	The area around Konia is enriched with iron along ancient cracks from the cataclysm. This not only provides the ore for steel production, but also sources Ochre, Umber, and Sienna which are used for pigments
