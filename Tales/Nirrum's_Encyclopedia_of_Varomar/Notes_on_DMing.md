...
To carry characters in a current, they must be swept up in one, they cannot be guided to one.
It is like trying to push a pencil by the tip. Liable to Jacknife. 

A character that picks up an item with more flow will get dragged along with it. 
A Character will react easily, but proacting is hard. A bike pushed will turn, a bike dragged will follow. 
![[~]]![[]] harmon story cycle
