...
### Dragonkin 
	Greater Dragonkin, myriad close subdivisions, and similar beings
	Diminutive Dragonkin
	Lesser Dragonkin, and similar beings
	

### Fey 
	Elf, myriad close subdivisions
	Gnome, and some close subdivisions
	Goblin
	Fairy, and myriad subdivisions
	

### Beastial beings 
	Feliniscan, other catfolk
	Lycanthropes and similar beings
	



### Grey Areas 
	Eldritch born, children of devils, fey, angels, gods, and other things that lie just out of sight
	Half-elves, Manarahi, 
...
Half-elf Variant: **Manarahi**
	...
	As a "Species", the Manarahi //mostly// descend from the most commonly compatible races, humans and elves being the most dominant through their history, though //every// Manarahi has the blood of dragons, fiends, celestials, and every sapient race that //could// be added to that gene pool. Today there are three main people of the Manarahi. The Ramishi have differed very little from halflings, but for the mostly-half-elf people, If you were born In Manaharamu or Kholira today, there's a chance this is what you'd look like, if you didn't look like something else. 
		**DM's Note:** For most purposes, this, alongside Human and Dragonborn, is the "default" race of the setting, by nature of being the most numerous
	...
	**Manaharahi**
		...
		**Octarine Receptors. **You have a vestigial sense, allowing you to see the color of magic, granting you advantage on any check made to percieve magic (including magical effects and spells) and an increase to passive ability checks to do so equal to your intelligence or charisma modifier (such as perception and insight). This does not work in magical darkness but can benefit from the use of a telescope, Microscope, or similar device. In Addition, if you have the //detect magic spell, //then its range is doubled **within line of sight. **

		**Vestigial Darkvision: **You can see Normally in Magical and Nonmagical darkness to a range of 5ft, though you lose the ability to see colour past that. You can see shades of grey for another 5ft beyond that. This sense does not benefit from a telescope or similar device. This sense ceases to function if the area you are looking at is in an antimagic field. If you are in a dense magic zone or during a wild magic surge, this effect extends to 100ft. With shades of grey 20ft beyond that. This benefit lasts until you leave the dense magic zone or at the end of your next turn for a wild magic surge.  This effect does not work when your eyes are closed.
	...
	**Kholirahi**
		...
		**Magical Darkvision. **You can see normally in darkness to a range of 30ft, including magical darkness, to a range of 30ft. This does not gain benefit from a telescope or similar device. If you are in a dense magic zone or during a wild magic surge, this effect extends to 300ft. With shades of grey 20ft beyond that. This benefit lasts until you leave the dense magic zone or at the end of your next turn for a wild magic surge. This darkvision ceases if you are in an antimagic field. This effect does not work when your eyes are closed
...
**Cosades.**
	...
	**Alignment**. Most Cosades are Good aligned.[Classes:Class Archetypes:Stars Patron](Classes/Class%20Archetypes/Stars%20Patron) All Cosades family members are driven and impetuous though very frequently become chaotic in accomplishing their goals
...
Human Variant
**Grao **
	**Age: **The grao can live up to 120 years, averaging near 80
	**Alignment: **The Grao tend to be very Neutral in order to remain adaptive
	**Size: **Your Size is Medium
	**Speed:** Your walking speed is 30 and you have a swim speed of 30
	**Languages: **You Speak Common and Aquan
	**Ability Score Increases: **Your Strength increases by 2 and your Intelligence increases by 1
	**Impetus: **You are proficient in all land and sea vehicles. You have advantage on  animal handling checks
	**Grao Polearm Mastery. **You are Proficient with halberds, Glaives, Tridents, spears, Pikes, Lances, and quarterstaffs
	**Witness of Lightning. **You know the Lightning Lure Cantrip and resist lightning damage. 

Orc Variant
**Aulufeydth**
	**Age**: The Aulufeydth tend to live less than 100 years
	**Alignment: **The Aulufeydth tend to be either extremely lawful or extremely chaotic, Within their culture, there is little difference
	**Size: Y**our size is medium
	**Speed: **Your base walking speed is 30
	**Languages: **You speak Common and Sylvan
	**Ability Score Increases: **Your strength increases by 2 and your intelligence by 1
	**Blindsight. **You have blindsight out to 30ft
	**Relentless Endurance. **Once between long rests, if you would hit 0 hp, you are brought to 1hp instead.
	**Leaping Cles. **The length of your long jump is doubled and the height of your high jump is tripled. Subtract your Jump height from the distance you have fallen for the purposes of calculating fall damage to yourself.
	**Fey Home. **You do not lose your bearings in the feywild, though you still need to know where you're going.
