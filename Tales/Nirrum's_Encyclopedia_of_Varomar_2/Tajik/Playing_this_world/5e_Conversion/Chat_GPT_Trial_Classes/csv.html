...
<!-- Header -->
<div class='header'>
	[ <a href='./Class_Breakdown.html'>Prev</a> ]

	[ <span class='insen'>Index</span> ]

	[ <a href='..\GPT_take_2.html'>Next</a> ]
</div>
...
<div class='pages'>
	<div class='heading'>
	<h1>csv <a name='Nirrum's Encyclopedia of Varomar 2:Tajik:Playing this world:5e Conversion:Chat GPT Trial Classes:csv'></a></h1>
	</div>
...
<p>
# Class list and maximum level<br>
classes = ["Barbarian", "Bard", "Cleric", "Druid", "Fighter", "Monk", "Paladin", "Ranger", <br>
...
<p>
# Feature Points gained per level<br>
fp_gain_per_level = [3, 3, 4, 4, 5, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 11, 11, 12, 12]<br>
...
<p>
# Save as CSV<br>
df.to_csv("dnd_feature_point_progression.csv", index=False)<br>
